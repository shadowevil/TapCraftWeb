...
export function saveWorld() {
  ...
  try {
    localStorage.setItem(worldKey(G.world.id), JSON.stringify({
      version: 6, id: G.world.id, name: G.world.name,
      ...
      wood: G.world.wood, stone: G.world.stone,
      tools: G.world.tools, craft: G.world.craft,
      buildings: G.world.buildings.map((b) => ({ id: b.id, type: b.type, col: b.col, row: b.row, facing: b.facing, produced: b.produced })),
