...
export const ui = {
  ...
  biomeSize: el("tc-biome-size"), biomeSizeVal: el("tc-biome-size-val"),
  decorDensity: el("tc-decor-density"), decorDensityVal: el("tc-decor-density-val"),
  decorCluster: el("tc-decor-cluster"), decorClusterVal: el("tc-decor-cluster-val"),
  weightMeadow: el("tc-weight-meadow"), weightMeadowVal: el("tc-weight-meadow-val"),
  weightPlains: el("tc-weight-plains"), weightPlainsVal: el("tc-weight-plains-val"),
  weightDry: el("tc-weight-dry"), weightDryVal: el("tc-weight-dry-val"),
  weightHighland: el("tc-weight-highland"), weightHighlandVal: el("tc-weight-highland-val"),
  weightForest: el("tc-weight-forest"), weightForestVal: el("tc-weight-forest-val"),
  weightJungle: el("tc-weight-jungle"), weightJungleVal: el("tc-weight-jungle-val"),
  ...
  cropGrowth: el("tc-crop-growth"), cropGrowthVal: el("tc-crop-growth-val"),
  wetBoost: el("tc-wet-boost"), wetBoostVal: el("tc-wet-boost-val"),
  seedChance: el("tc-seed-chance"), seedChanceVal: el("tc-seed-chance-val"),
